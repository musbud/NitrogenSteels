...
Similar to the MLR model, Parameter_3 is the most important process parameter for controlling the nitrogen content in the **p**ressure-**e**lectro**s**lag-**r**emelting furnace. As this parameter increases, the nitrogen content in the molten steel also increases.
